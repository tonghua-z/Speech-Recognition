"""
Saves the lists of the states and the phonemes based on the trained HMM models
"""
...
DEFAULT_HMM_MODELS_PATH= "lab2_models_v2.npz"
...
def get_arguments():
    ...
    parser.add_argument("--phoneme-list-path", type=str, default=DEFAULT_PHONEME_LIST_PATH,
                        help="Path of the directory where the list of phonemes will" + \
                        " be saved. This should contain the file name in the end.")
...
hmmModels = np.load(args.hmm_models_path, allow_pickle=True)['phoneHMMs'].item()
...
print("Saving phoneme list...")
np.save(args.phoneme_list_path, phones)
print("Phoneme list saved.")
